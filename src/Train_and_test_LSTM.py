...
model = LSTM(inputSize=features, hiddenSize=hiddenSize,
...
for epoch in range(0,num_epochs):
    ...
    if epoch % 10 == 0:
        ...
        trainLoss = 0
        # trainOutput = model(trainData)
        # trainLoss = criterion(trainOutput, trainLable)
        for t in range(0, trainData.shape[0]):
            trainTemp = trainData[t,:,:]
...
PATH = "netModel/LSTM_simple_outRe_state_{}epoch.pth".format(num_epochs)
